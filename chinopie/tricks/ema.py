...
class ModelEma(Module):
    ...
    def __init__(
        ...
        if ema_model is not None:
            ...
            try:
                ...
                raise ValueError(f'Error: While trying to deepcopy model: {e}') from e
    ...
    @property
    def model(self):
        return self.online_model if self.include_online_model else self.online_model[0] # type: ignore
